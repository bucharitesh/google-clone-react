      ...
      >
        ...
        <g id="elcome-mask">
          <g clipPath="url(#clip-path)">
            <path
              id="me"
              d="M850.5,408.5c8,20,14,68,7,80s15-61,23-83,22-51,19-65,3,31,5,42,21,84,15,95,6-29,10-47,26-72,23-81,1,19,4,37,11,43,16,51,14,10,20,4,15-23,24-23,9,5,19-2,23-25,28-37,6-22,0-30-14-5-24,0-12,14-17,25-7,13-6,30,2,26,8,34,16,13,29,14,31-10,40-20,25-35,25-35"
              transform="translate(-220.11 -222.79)"
              fill="none"
              stroke="#000"
            ...
            <path
              id="om"
              d="M749.5,418.5s0,23,5,30,16,9,22,5,11-10,15-16,10-27,11-44-2-28-8-32-15-2-22,4-5,9-5,17,4,21,9,30,21,17,27,19,22-2,27-6,18-11,20-17-7-25-11-34-15-20-15-20"
              transform="translate(-220.11 -222.79)"
              fill="none"
              stroke="#000"
              stroke-miterlimit="10"
            ...
            <path
              id="co"
              d="M648.5,418.5s2,14,8,25,7,15,17,20,10,5,21,2,25-11,35-24,19-17,20-23,0-25,3-32,10-12,10-12"
              transform="translate(-220.11 -222.79)"
              fill="none"
              stroke="#000"
              stroke-miterlimit="10"
            ...
            <path
              id="lc"
              d="M587.5,412.5s2,19,5,29,10,18,16,18,16-9,24-18,11-9,16-23,3-20,9-32,14-21,20-25,7-9,21-12,12,9,11,17-2,14-5,22-11,16-11,16"
              transform="translate(-220.11 -222.79)"
              fill="none"
              stroke="#000"
              stroke-miterlimit="10"
            ...
            <path
              id="el"
              d="M494.5,409.5s26-15,33-30,6-29-5-34-25,10-30,19-10,21-9,40,3,46,11,52,30,6,43,0,34-25,39-30,9-9,11-14-2-41,0-72,12-87,12-87"
              transform="translate(-220.11 -222.79)"
              fill="none"
              stroke="#000"
              stroke-miterlimit="10"
        ...
        <g id="w-mask">
          <g clipPath="url(#clip-path-2)">
            <path
              id="cur1"
              d="M251,240s-11,54-13,111-1,61,7,80,18,21,32,23,23-10,30-19c13-13,46-113,42-114s-1,93,3,104,9,34,24,44,12,10,29,5,29-27,37-48,16-57,17-89-2.4-47.1-6-68c-5-29-9-31-9-31"
              transform="translate(-220.11 -222.79)"
              fill="none"
              stroke="#000"
              stroke-miterlimit="10"
